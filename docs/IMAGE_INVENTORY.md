...
## 2026-06-12 Local Images After job-service Orchestration Smoke

These images were rebuilt and smoke-tested locally after adding `JOB_SERVICE_REPOSITORY=postgres`, the PostgreSQL JSONB repository, and `scripts/dev/smoke-job-orchestration-live.sh`. Docker Hub push was not attempted.

| Image | Tag | Local image id | Registry digest |
| --- | --- | --- | --- |
| `petoo/file-translation-job-service` | `0.1.0` | `sha256:92a595303cb88be46e9f00ca2e71459b67c6203fd2467afcfe28861286cd01e9` | Not available; not pushed. |
...
## 2026-06-12 Local Images After email_send End-State Live Smoke

These images were rebuilt and smoke-tested locally after adding `scripts/dev/smoke-email-end-state-live.sh` and the bounded PostgreSQL startup retry in `job-service`. Docker Hub push was not attempted.
...
## 2026-06-12 Local Images After HWPX Route E2E Smoke

These images were rebuilt and smoke-tested locally while validating `scripts/dev/smoke-hwpx-route-e2e.sh`. Docker Hub push was not attempted.
...
## 2026-06-12 Local Images After DOCX Route E2E Smoke

These images were rebuilt and smoke-tested locally while validating `scripts/dev/smoke-docx-route-e2e.sh`. Docker Hub push was not attempted.
...
## 2026-06-12 Local Images After Operation/API Docs Validation

These images were rebuilt and smoke-tested again while validating the operation/API/admin/replacement documentation update. No image source changes were made in this docs step, so the local image IDs remain the same as the PDF route E2E checkpoint. Docker Hub push was not attempted.
...
## 2026-06-12 Local Images After Admin API/UI Readiness

These images were rebuilt and smoke-tested while validating `feat/admin-api-ui-readiness`. The `job-service` image changed because the public/admin APIs and lightweight `/admin` UI skeleton were added. Docker Hub push was not attempted.

| Image | Tag | Local image id | Registry digest |
| --- | --- | --- | --- |
| `petoo/file-translation-job-service` | `0.1.0` | `sha256:669c8c7cf3ee66f604baea82d5f8ed813fbd425691a400d634c401cb5e99ba40` | Not available; not pushed. |
| `petoo/file-translation-pdf2docx-worker` | `0.1.0` | `sha256:7e1317db6e60c90abf53424968de3da25e78143b03fadd518e4eabf5b9fb871a` | Not available; not pushed. |
| `petoo/file-translation-docx-extract-worker` | `0.1.0` | `sha256:b4dfe4429df731a6e60295c8bf5a1df5612fdeeabb53487d5c0cbcf139563482` | Not available; not pushed. |
| `petoo/file-translation-translate-worker` | `0.1.0` | `sha256:5531c68f183a7d331beeb738c2e296a0d9ec27d4fe6b1da15f0f09c07ed2ac72` | Not available; not pushed. |
| `petoo/file-translation-docx-replace-worker` | `0.1.0` | `sha256:0895e4887d9c4b19f3b0459a1507d58d02a37e08b410d0de7802fbaeb29d4071` | Not available; not pushed. |
